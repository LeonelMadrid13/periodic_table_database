...
--
-- Name: properties types_pkey; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--
...
--
-- Name: properties properties_type_if_fk; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT properties_type_if_fk FOREIGN KEY (type_id) REFERENCES public.types(type_id);
